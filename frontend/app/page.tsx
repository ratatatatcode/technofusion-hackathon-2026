...
const howItWorks = [
  ["1", "🎯", "PICK A QUEST", "Browse the mission feed. Filter by tier, SDG, or your department."],
  ["2", "📸", "DO IT IRL", "Complete the mission, snap your proof, drop the event code if applicable."],
  ["3", "🏆", "EARN COINS", "Get verified, stack points, climb the leaderboard, unlock badges."],
] as const;
    ...
    <>
      ...
      <header className="relative z-2 flex flex-col items-center justify-center text-center px-6 pt-16 pb-24 min-h-[78vh] overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 z-0">
          <div className="question-block absolute! top-[14%] left-[8%] w-14! h-14! text-2xl! max-[900px]:hidden!">
            <span>?</span>
          </div>
          <div
            className="question-block absolute! top-[22%] right-[10%] w-12! h-12! text-xl! max-[900px]:hidden!"
        ...
        <p className="world-tag relative z-1">★ WORLD 1-1 ★</p>
        <h1 className="title-main relative z-1 text-center! max-[900px]:text-[40px]! max-[600px]:text-[28px]!">
          LEVEL UP
          <br />
          <span className="yellow">YOUR</span> <span className="red">CAMPUS</span>
        </h1>
        <p className="subtitle relative z-1 max-w-[640px] mx-auto text-center!">
          Complete quests, earn coins, climb the leaderboard, and solve real campus problems for the SDGs.
        </p>
      ...
      <section className="relative z-2 py-16 px-[8%]">
        <h2 className="section-title"><span className="yellow">★</span> HOW IT WORKS <span className="yellow">★</span></h2>
        <p className="section-sub">Three steps. Infinite quests. One leveled-up campus.</p>
        <div className="grid gap-6 grid-cols-3 max-w-[1100px] mx-auto max-[900px]:grid-cols-1">
      ...
      <section className="relative z-2 py-16 px-[8%]">
        ...
        <div className="grid gap-6 grid-cols-[repeat(auto-fit,minmax(240px,1fr))] max-w-[1300px] mx-auto max-[900px]:grid-cols-1">
      ...
      <section className="relative z-2 py-16 px-[8%]">
        ...
        <p className="section-sub">From daily good deeds to legendary contest battles.</p>
      ...
      {/* CTA */}
      <section className="relative z-2 py-16 px-[8%] pb-[120px]">
        <div className="cta-box max-w-[820px] mx-auto">
