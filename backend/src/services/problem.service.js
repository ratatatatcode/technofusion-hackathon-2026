...
export const createProblemWithQuests = async ({ userId, title, description }) => {
    ...
    try {
        ...
        const questValues = quests.map(q => [problemId, q.title, q.description]);
        await connection.query(
            "INSERT INTO problem_quests (problem_id, title, description) VALUES ?",
            [questValues]
        );
